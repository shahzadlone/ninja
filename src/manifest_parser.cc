...
bool ManifestParser::Load(const std::string& filename, std::string* err, Lexer* parent) {
  ...
  // It takes a std::string_view, and std::string_view's std::string constructor uses
